...
if __name__ == "__main__":
    ...
    stop_early = EarlyStoppingLossThresholdCallback(patience=10, threshold=1.0, delta=0.1)
    ...
    train_args = DPOConfig(
        ...
        seed=0,
        push_to_hub=True,
        hub_model_id="ExplosionNuclear/Llama-3.2-3B-bnb-4bit-step4-checkpoints",
        hub_token=hf_token,
        weight_decay=0.01
    )
